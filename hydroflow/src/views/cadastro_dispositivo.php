        ...
        <form action="#" method="post"class="register" id="register">
            <div class="form-group">
                ...
                <div class="input-field">
                    ...
                    <select class="input  <?= $errors['zona'] ? 'invalid' : '' ?>" name="id_zona" id="id_area">
                        <option value="" id="zona">Selecione uma Zona...</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="input-field">
                    ...
                    <input class="input  <?= $errors['nome_dispositivo'] ? 'invalid' : '' ?>" type="text" name="nome_dispositivo" id="nome_dispositivo" value="<?= $nome_dispositivo ?>"/>
                    <div class="invalid-feedback"><?= $errors['nome_dispositivo'] ?></div>
                </div>
                <div class="input-field">
                    <label for="modelo_dispositivo">Modelo do Dispositivo</label>
                    <input class="input  <?= $errors['modelo_dispositivo'] ? 'invalid' : '' ?>" type="text" name="modelo_dispositivo" id="modelo_dispositivo" value="<?= $modelo_dispositivo ?>"/>
            ...
            <div class="form-group">
                <div class="input-field">
                    ...
                    <textarea class="input textarea" name="descricao" id="descricao" cols="30" rows="10"  value="<?= $descricao ?>"></textarea>
                </div>
            </div>
            <div class="btn-box">
